...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0008_alter_organizationsettings_email_copy_address_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor_email', models.CharField(blank=True, max_length=254, verbose_name='Actor (email)')),
                ('action', models.CharField(db_index=True, max_length=32, verbose_name='Acción')),
                ('model', models.CharField(blank=True, db_index=True, max_length=64, verbose_name='Modelo')),
                ('object_id', models.CharField(blank=True, max_length=64, verbose_name='ID objeto')),
