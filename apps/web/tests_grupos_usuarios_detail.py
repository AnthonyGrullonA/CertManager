...
class GroupDetailTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.contrib = User.objects.create_user("contrib@x.test", PWD)
        ...
        Membership.objects.create(user=cls.contrib, team=cls.team, role=MembershipRole.CONTRIBUTOR)
    ...
    def test_contributor_cannot_manage(self):
        # La gestión de miembros es exclusiva del Owner.
