...
echo ">> Instalando dependencias (markdown-it + puppeteer-core, sin descargar Chromium)…"
export PUPPETEER_SKIP_DOWNLOAD=1
npm install --silent --no-audit --no-fund markdown-it puppeteer-core >/dev/null 2>&1
